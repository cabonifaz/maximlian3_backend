...
{
    public class UsuarioRepositorioSql : IUsuarioRepository
    {
        private readonly DbConfig _dbConfig;
        private readonly ILogger<UsuarioRepositorioSql> _logger;

        public UsuarioRepositorioSql(DbConfig dbConfig, ILogger<UsuarioRepositorioSql> logger)
        {
            _dbConfig = dbConfig;
            _logger = logger;
        }
