...
{
    public class LoginRepositorioSql : ILoginRepository
    {
        private readonly DbConfig _dbConfig;
        private readonly ILogger<LoginRepositorioSql> _logger;

        public LoginRepositorioSql(DbConfig dbConfig, ILogger<LoginRepositorioSql> logger)
        {
            _dbConfig = dbConfig;
            _logger = logger;
        }
        ...
        public async Task<Respuesta> AutenticarAsync(UsuarioGeneral usuarioActual)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@p_vchSub", MySqlDbType.VarChar, 255).Value = usuarioActual.Sub;
