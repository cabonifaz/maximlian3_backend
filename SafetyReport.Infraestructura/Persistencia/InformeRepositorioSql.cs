...
{
    public class InformeRepositorioSql : IInformeRepository
    {
        private readonly DbConfig _dbConfig;
        private readonly ILogger<InformeRepositorioSql> _logger;

        public InformeRepositorioSql(DbConfig dbConfig, ILogger<InformeRepositorioSql> logger)
        {
            _dbConfig = dbConfig;
            _logger = logger;
        }
